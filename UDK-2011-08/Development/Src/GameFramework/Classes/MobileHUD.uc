...
function PostRender()
{
	...
	if (bShowMotionDebug)
	{
		...
		if (MPI != none)
		{
			...
			Canvas.SetPos(0,70);
			DrawMobileDebugString(0,50,"Accelerometer: "@ MPI.DeviceAccelerometerRawData);
			if (MPI.bDeviceHasGyroscope)
			{
				DrawMobileDebugString(0,70,"Gyro: "@ MPI.DeviceGyroRawData);
			}
			DrawMobileDebugString(0,90,"[Mobile Motion]");
			DrawMobileDebugString(0,110,"Attitude: Pitch=" $ (MPI.DeviceMotionAttitude.X * (180/PI)) @ "Yaw=" $ (MPI.DeviceMotionAttitude.Y * (180/PI)) @ "Roll=" $ (MPI.DeviceMotionAttitude.Z * (180/PI)));
			DrawMobileDebugString(0,130,"Rotation:" @ MPI.DeviceMotionRotationRate.X @ MPI.DeviceMotionRotationRate.Y @ MPI.DeviceMotionRotationRate.Z);
			DrawMobileDebugString(0,150,"Gravity:" @ MPI.DeviceMotionGravity.X @ MPI.DeviceMotionGravity.Y @ MPI.DeviceMotionGravity.Z);
			DrawMobileDebugString(0,170,"Accleration:" @ MPI.DeviceMotionAcceleration.X @ MPI.DeviceMotionAcceleration.Y @ MPI.DeviceMotionAcceleration.Z);
		}
	}
