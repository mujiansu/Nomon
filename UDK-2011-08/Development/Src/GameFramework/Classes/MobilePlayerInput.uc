...
cpptext
{
	 ...
	 * @param TouchpadIndex		The index of the touchpad this touch came from
	 */
	virtual void InputTouch(UINT Handle, BYTE Type, FVector2D TouchLocation, DOUBLE DeviceTimestamp, UINT TouchpadIndex=0);
	 ...
	 */
	UBOOL ProcessMenuInput(UINT TouchHandle, UINT TouchpadIndex, EZoneTouchEvent EventType, FVector2D TouchLocation);
